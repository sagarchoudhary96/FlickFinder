# Flickr
An iPhone app that let you search for random images based on the user's **text phrase** or their **location** coordinates.
## Requirements
...
* Using Web services and APIs to search for data based on user input.
